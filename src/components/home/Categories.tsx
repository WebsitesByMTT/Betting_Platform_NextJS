...
const Categories = () => {
  const data = [
    {
      icon: "/assets/image/categoryicon1.svg",
      hovericon: "/assets/image/categoryhovericon1.svg",
      text: "All",
    },
    {
      icon: "/assets/image/categoryicon2.svg",
      hovericon: "/assets/image/categoryhovericon2.svg",
      text: "Cricket",
    },
    {
      icon: "/assets/image/categoryicon3.svg",
      hovericon: "/assets/image/categoryhovericon3.svg",
      text: "Football",
    },
    {
      icon: "/assets/image/categoryicon4.svg",
      hovericon: "/assets/image/categoryhovericon4.png",
      text: "Basketball",
    },
    {
      icon: "/assets/image/categoryicon6.svg",
      hovericon: "/assets/image/categoryhovericon6.svg",
      text: "Table tennis",
    },
    {
      icon: "/assets/image/categoryicon7.svg",
      hovericon: "/assets/image/categoryhovericon7.svg",
      text: "Volleyball",
    },
    {
      icon: "/assets/image/categoryicon8.svg",
      hovericon: "/assets/image/categoryhovericon8.svg",
      text: "Fifa",
    },
    {
      icon: "/assets/image/categoryicon9.svg",
      hovericon: "/assets/image/categoryhovericon9.svg",
      text: "Ice Hockey",
    },
    {
      icon: "/assets/image/categoryicon10.svg",
      hovericon: "/assets/image/categoryhovericon10.svg",
      text: "Horse Racing",
    },
    {
      icon: "/assets/image/categoryicon11.svg",
      hovericon: "/assets/image/categoryhovericon11.svg",
      text: "Badminton",
    },
    {
      icon: "/assets/image/categoryicon12.svg",
      hovericon: "/assets/image/categoryhovericon12.svg",
      text: "Baseball",
    },
  ];
    ...
    <div className="pt-3">
            ...
            {data?.map((item, ind) => (
              <div key={ind} className="cursor-pointer m-1 flex-shrink-0">
                <div className="hover:bg-gradient-to-tr mx-auto group  from-[#D6A250] via-[#FFE500] to-[#ECB800] w-[45px] md:w-[50px] p-[1px] rounded-xl">
                  <div className="bg-[#343434] h-[40px] p-[.8rem] rounded-xl  shadow-inner shadow-[#232323]">
                    <Image
                      src={item.hovericon}
                      alt="categories"
                      width={100}
                ...
                <div className="text-center text-white md:block hidden text-[.85rem] md:text-[.75rem] pt-1">
                  {item.text}
                </div>
              </div>
            ))}
      ...
      <div className="bg-[#323232] flex items-center justify-between px-3 md:px-6 mt-3 md:mt-6 py-2 rounded-[1rem] shadow-inner shadow-[#232323]">
        <div className="flex items-center space-x-3 md:space-x-6">
          <Image
            src={"/assets/image/topbets.svg"}
            alt="categories"
            className="w-[25px] md:w-[45px]"
            width={100}
            height={100}
            quality={100}
          />
          <span className="text-[.8rem] md:text-[1rem] lg:text-[1.5rem] text-white">
            Top Bets
          </span>
        </div>
        <div className="flex items-center space-x-3">
          <div className="bg-[#0E1013] flex items-center space-x-2 rounded-full p-1 md:p-2">
            <div className="parant rotate-180 cursor-pointer transition-all">
              <svg
                width="24"
                className="my-arrow-svg w-[17px] md:w-[35px]"
                height="24"
                viewBox="0 0 26 27"
                fill="none"
          ...
          <div className="flex items-center space-x-1">
            <div className="uppercase text-white text-[.8rem] md:text-[1rem]">
              See All
            </div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              className="lucide w-[25px] md:w-[35px] cursor-pointer text-white lucide-chevrons-right"
            >
