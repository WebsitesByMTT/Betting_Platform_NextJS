...
const Sidebar = () => {
  ...
  const sidebar = [
    ...
    },
    {
      ...
      subTitle: [
        {
          icon: <svg className='my-svg-icon w-[2.5rem]' viewBox="0 0 33 30" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          icon: <svg className='my-svg-icon w-[2.5rem]' viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          icon: <svg className='my-svg-icon w-[2.5rem]' viewBox="0 0 38 37" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      subTitle: [
        ...
        {
          icon: <svg className='my-svg-icon w-[2.5rem]' viewBox="0 0 38 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          icon: <svg viewBox="0 0 30 31" className='my-svg-icon w-[2.5rem]' fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    ...
    <div className={`absolute left-5 top-5 md:hidden text-white ${toggle?'hidden':'block'}`} onClick={handeltoggle}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-align-left"><line x1="21" x2="3" y1="6" y2="6"/><line x1="15" x2="3" y1="12" y2="12"/><line x1="17" x2="3" y1="18" y2="18"/></svg></div>
      <div className={`${toggle?'transition left-0':'transition left-[-200%]'} text-white  z-10 md:z-0  bg-primary fixed md:top-[-200px] md:sticky p-[2rem]`}>
        <div className={`absolute right-3 top-2 md:hidden text-white ${toggle?'block':'hidden'}`} onClick={handeltoggle}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-x"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></div>
        <div>
          <Image src="/assets/image/logo.png" height={500} quality={100} className='w-[170px] mx-auto' width={500} alt="logo" />
        </div>
        <div className='py-[1rem] space-y-[1rem]'>
          {
            sidebar?.map((item, ind) => (
              <div key={ind} className='bg-[#202124] px-[1rem] rounded-[1rem] py-[.7rem]'>
                <div className='flex items-center cursor-pointer justify-between '>
                  <div className='text-[1.2rem] uppercase'>{item.title}</div>
                  <Image src="/assets/image/arrowIcon.png" height={500} className='w-[1.8rem] h-[1.8rem]' width={500} alt="logo" />
                </div>
                {item?.subTitle?.length > 0 && <div className='space-y-[.6rem] pt-[.6rem]'>
                  {item?.subTitle?.map((subitem, subind) => (
                    <div key={subind} className='from-[#D6A250] shadow-inner via-[#FFE500] parant to-[#ECB800] hover:bg-gradient-to-r transition-all cursor-pointer rounded-[1rem] p-[2px]'>
                      <div className='bg-[#2E3134] flex items-center space-x-[.6rem] px-[.6rem] py-[.3rem] rounded-[1rem]'>
                        {subitem.icon}
                        ...
                        <div className='text-[1rem]'>{subitem.text}</div>
                      </div>
                    </div>
                  ))}
                </div>}
