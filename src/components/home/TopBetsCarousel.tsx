            ...
            >
                <CarouselContent className='space-x-3'>
                    {Array.from({ length: 5 }).map((_, index) => (
                        <CarouselItem key={index} className="md:w-[25px] basis-[100%] md:basis-[48.5%] xl:basis-[32.5%]">
                            <div className="flex justify-between p-3 space-x-4 bg-[#292D2E] rounded-lg">
                                ...
                                <div>
                                    <div className='text-white text-[.8rem] lg:text-[1rem]'>Wilson Kenter</div>
                                    <div className='text-white text-[.7rem] lg:text-[.8rem] text-opacity-60'>To Win Match</div>
                                    <div className='text-white text-[.7rem] lg:text-[.8rem] text-opacity-60'>Wilson Kenter Vs Allison Vetrovs</div>
                                ...
                                <div>   
                                  <div className='bg-[#343434] text-[.8rem] md:text-[.8rem] xl:text-start text-center mt-2 xl:mt-0 px-4 py-2 md:py-3 md:px-6 rounded-2xl text-white'>4.678</div>
                                </div>
                            </div>
                        </CarouselItem>
                    ))}
