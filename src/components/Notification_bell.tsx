...
const Notification_bell = ({ isOpen }: { isOpen: boolean }) => {
  ...
  return (
    <div className={` absolute top-[80%] ${isOpen?'scale-100':'hidden'}  transition-all md:right-0 mobileleft z-[504] translate-x-[-50%] md:transform-none translate-y-[0%] md:top-[100%]`}>
      <div className={`w-[96vw] ${isOpen?'scale-100':'scale-0'} transition-all md:w-[400px] bg-[#2b2831]`}>
