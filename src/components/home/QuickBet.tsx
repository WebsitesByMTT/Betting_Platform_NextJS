...
const QuickBet = () => {
    ...
    return (
        ...
        <div className={`transition-all text-white  ${open ? 'bottom-0' : '-bottom-[2rem] md:-bottom-[4rem]'}  fixed  z-[20] mx-[5%] left-0 md:left-auto md:right-20 w-[90%] md:w-[45%] xl:w-[27%]`}>
            ...
            <div className={`bg-[#0E0F11] ${open ? 'space-y-2 max-h-[500px] transition-all duration-300 ease-in-out overflow-hidden' : 'max-h-0  transition-all duration-300 ease-in-out overflow-hidden'} px-2 md:px-6 py-4 md:py-8`}>
                ...
                <div className='pt-8 pb-6'>
                    <input type="text" placeholder='Enter Booking Code' className='outline-none w-[80%] p-3 rounded-lg bg-[#1C1E22] placeholder:text-white mx-[10%]' />
                </div>
