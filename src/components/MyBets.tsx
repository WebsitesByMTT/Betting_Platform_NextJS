...
const MyBets = () => {
  ...
  console.log(myBets,"Hellow My Bets")
                    ...
                    >
                            ...
                            <span className="text-[9px]  md:text-[13px] text-left">
                              {data?.teams?.map((team: any, index: number) => (
                                <span
                                  key={index}
                                  className={
                                    (data?.bet_on?.name === team?.name)||(data?.bet_on?.name==='Draw')
                                      ? `${data?.status === "redeem"
                                        ? "text-[#57555f]"
                                        : "text-[#FFC400]"
                                      }`
                      ...
                      >
                        <div className="flex flex-col">
                          ...
                          <span className={`text-[.84rem] ${data?.category == 'h2h' && 'hidden'} text-opacity-60 text-white dark:text-black`}>{data?.bet_on?.points}</span>
                        </div>
                      </td>
                    ...
                    {item?.data?.map((data: any, dataIndex: any) => (
                      ...
                      >
                        ...
                        >
                          <div className="flex flex-col">
                            <span>{data?.category}</span>
                            <span className={`text-[.84rem] ${data?.category == 'h2h' && 'hidden'} text-opacity-60 text-white`}>{data?.bet_on?.points}</span>
                          </div>
                        </td>
                        <td className="text-sm md:text-lg">
                          <div className="flex flex-col gap-2">
