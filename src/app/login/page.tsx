...
const Login = () => {
  ...
  return (
    <div className=" bg-[#1a1a1d] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] backdrop-filter backdrop-blur-[5px] bg-opacity-10 flex z-[1] items-center justify-center w-full  rounded-[1.8vw] p-5">
      <form
