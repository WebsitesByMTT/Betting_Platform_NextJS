    ...
    return (
        <div>
            <div className='pt-5 cursor-pointer flex space-x-2 items-center'>
                <svg width="30" height="30" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='text-[1.3rem] text-white'>Live</div>
                ...
                <div className='bg-[#292D2E] shadow-xl  p-2 rounded-lg col-span-12 md:col-span-3'>
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center space-x-[.5px]'>
                            ...
                            <div className='text-white text-opacity-60 text-[.9rem]'>International</div>
                            ...
                            <div className='text-white  text-[.8rem]'>TT Elite Series</div>
                        </div>
                        <div>
                    ...
                    <div className='flex py-1 items-center justify-between'>
                        <div className='text-[#67FFFF] text-[.9rem]'>1st set</div>
                        <div>
                    ...
                    <div className='flex items-center py-1.5 justify-between'>
                        <div className='flex items-center space-x-2'>
                            ...
                            <div className='text-white text-[.9rem]'>Alfonso,Switzerland</div>
                        </div>
                        <div className='flex items-center space-x-4'>
                            <div className='text-white text-[.9rem]'>4</div>
                            <div>
                                <div className='text-white text-opacity-60 text-[.9rem] px-3 border border-opacity-45 border-white bg-[#1A1A1A] rounded-md'>0</div>
                            </div>
                        </div>
                    ...
                    <div className='flex items-center py-1.5 justify-between'>
                        <div className='flex items-center space-x-2'>
                            ...
                            <div className='text-white text-[.9rem]'>Zain,Algeria</div>
                        </div>
                        <div className='flex items-center space-x-4'>
                            <div className='text-white text-[.9rem]'>4</div>
                            <div>
                    ...
                    <div className='pt-1'>
                        <div className='text-white text-[.9rem]'>Winner</div>
                        <div className='flex items-center justify-between pt-2'>
                            ...
                            <div className='w-[18%] bg-[#1A1A1A] relative p-2 cursor-pointer rounded-md flex items-center justify-between'>
