                ...
                <div className='flex items-center space-x-3'>
                    <div className='bg-[#0E1013] flex items-center space-x-2 rounded-full p-1 md:p-2'>
                        <div className='parant rotate-180 cursor-pointer transition-all'>
                            <svg width="24" className='my-arrow-svg w-[17px] md:w-[35px]' height="24" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex items-center space-x-1'>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" className="lucide w-[25px] md:w-[35px] cursor-pointer text-white lucide-chevrons-right"><path d="m6 17 5-5-5-5" /><path d="m13 17 5-5-5-5" /></svg>
                    </div>
                </div>
            </div>
        </div >
