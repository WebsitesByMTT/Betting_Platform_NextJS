...
const Sidebar = () => {
      ...
      subTitle: [
        {
          icon: (
            <svg
              className="my-svg-icon w-[2.2rem]"
              viewBox="0 0 33 30"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="shape"
                    result="effect1_innerShadow_1_808"
                  />
                </filter>
                <linearGradient
                  id="paint0_linear_1_808"
                  x1="16.4612"
                  y1="30.0017"
                  x2="16.4612"
                  y2="0"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_1_811"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_1_811"
                    result="shape"
                  />
                </filter>
                <linearGradient
                  id="paint0_linear_1_811"
                  x1="18.8075"
                  y1="4.00665"
                  x2="18.8075"
                  y2="34.1167"
        ...
        },
        {
          icon: (
            <svg
              className="my-svg-icon w-[2.6rem]"
              viewBox="0 0 38 37"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_1_818"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_1_878"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_1_878"
                    result="shape"
                  />
                </filter>
                <linearGradient
  ...
  return (
    <div className="lg:col-span-3 xl:col-span-2">
      ...
      <div
        className={`${
          toggle ? "transition-all left-0" : "transition-all left-[-200%]"
        } text-white  z-50 lg:z-0  bg-primary h-screen overflow-y-scroll fixed lg:top-[-0px] lg:sticky w-[60%] md:w-[30%] lg:w-auto col-span-2 p-[1rem] md:p-[1rem]`}
      >
        <div
        ...
        <div>
          <Image
            ...
            width={500}
            quality={100}
            className="w-[100px] md:w-[120px] lg:w-[170px] mx-auto"
            alt="logo"
          />
        </div>
        <div className="py-[1rem] space-y-[1rem]">
          {sidebar?.map((item, ind) => (
            <div
              key={ind}
              className={`bg-[#202124] px-[.5rem] rounded-[.5rem] ${
                index.includes(ind) ? "pb-[1rem]" : "pb-[.4rem]"
              } pt-[.4rem]`}
            >
              <div
                onClick={() => handelopen(ind)}
                className="flex items-center cursor-pointer py-[.2rem] md:py-2 justify-between "
              >
                <div className="text-[.9rem] md:text-[1rem] uppercase">
                  {item.title}
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className={`lucide border-white border-opacity-50 ${
                    index.includes(ind) ? "rotate-180" : ""
                  } transition-all md:w-[23px] md:h-[23px] bg-black rounded-md border-[.2px] lucide-chevron-down`}
                >
                  <path d="m6 9 6 6 6-6" />
                </svg>
              </div>
              {item?.subTitle?.length > 0 && (
                <div
                  ...
                  style={{ opacity: index.includes(ind) ? 1 : 0 }}
                >
                  {item?.subTitle?.map(
                    (subitem, subind) =>
                      index.includes(ind) && (
                        <div
                          key={subind}
                          className="from-[#D6A250] shadow-inner via-[#FFE500] parant to-[#ECB800] hover:bg-gradient-to-r transition-all cursor-pointer rounded-[.5rem] p-[2px]"
                        >
                          <div className="bg-[#2E3134] flex items-center justify-normal px-[.6rem] py-[.5rem] rounded-[.5rem]">
                            ...
                            <div className="text-[.8rem] md:text-[.9rem] text-start w-[100%]">
                              {subitem.text}
                            </div>
                          </div>
                        </div>
