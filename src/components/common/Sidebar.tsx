...
const Sidebar = () => {
  ...
  const sidebar = [
    ...
    },
    {
      ...
      subTitle: [
        {
          icon: <svg className='my-svg-icon w-[2vw]' viewBox="0 0 33 30" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          icon: <svg className='my-svg-icon w-[2vw]' viewBox="0 0 38 39" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          icon: <svg className='my-svg-icon w-[2vw]' viewBox="0 0 38 37" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      subTitle: [
        ...
        {
          icon: <svg className='my-svg-icon w-[2vw]' viewBox="0 0 38 34" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
          icon: <svg viewBox="0 0 30 31" className='my-svg-icon w-[2vw]' fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className='text-white sticky top-[-40vw] p-[1.5vw]'>
    <div>
      <Image src="/assets/image/logo.png" height={500} quality={100} className='w-[10vw] mx-auto' width={500} alt="logo" />
    </div>
    <div className='py-[1vw] space-y-[1vw]'>
      {
        sidebar?.map((item, ind) => (
          <div key={ind} className='bg-[#202124] px-[1vw] rounded-[.7vw] py-[.5vw]'>
            <div className='flex items-center cursor-pointer justify-between '>
              <div className='text-[1vw] uppercase'>{item.title}</div>
              <Image src="/assets/image/arrowIcon.png" height={500} className='w-[1vw] h-[1vw] sm:w-[1.5vw] sm:h-[1.5vw]' width={500} alt="logo" />
            </div>
            {item?.subTitle?.length > 0 && <div className='space-y-[.8vw] pt-[.8vw]'>
              {item?.subTitle?.map((subitem, subind) => (
                <div key={subind} className='from-[#D6A250] shadow-inner via-[#FFE500] parant to-[#ECB800] hover:bg-gradient-to-r transition-all cursor-pointer rounded-[.8vw] p-[.1vw]'>
                  <div className='bg-[#2E3134] flex items-center space-x-[.7vw] px-[.5vw] py-[.2vw] rounded-[.8vw]'>
                    {subitem.icon}
                    <svg className='w-[2vw]' viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="paint0_linear_1_881" x1="15" y1="0.370056" x2="15" y2="30.3701" gradientUnits="userSpaceOnUse">
                          <stop stop-color="#D9D9D9" />
                          <stop offset="1" stop-color="#5F6368" />
                    ...
                    <div className='text-[.8vw]'>{subitem.text}</div>
                  </div>
                </div>
              ))}
            </div>}
